  ...
  return (
      ...
      <Accordion type="single" collapsible className="w-full">
        <AccordionItem value="item-1">
          <AccordionTrigger className="md:text-xl text-primary-2">What is TalentSphere, and who can use it?</AccordionTrigger>
        ...
        <AccordionItem value="item-2">
          <AccordionTrigger className="md:text-xl text-primary-2">How does TalentSphere help with employee management?</AccordionTrigger>
          <AccordionContent className="text-gray-600 text-base">
          ...
          <AccordionTrigger className="md:text-xl text-primary-2">How is data security handled in TalentSphere?</AccordionTrigger>
          <AccordionContent className="text-gray-600 text-base">
          ...
          <AccordionTrigger className="md:text-xl text-primary-2"> How do I submit a task in the Work-Sheet section?</AccordionTrigger>
          <AccordionContent className="text-gray-600 text-base">
          ...
          <AccordionTrigger className="md:text-xl text-primary-2">What happens if my salary information is incorrect?</AccordionTrigger>
          <AccordionContent className="text-gray-600 text-base">
